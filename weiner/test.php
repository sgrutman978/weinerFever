...
<div data-display="3" class="display standings">
	...
	<?php $sql = "SELECT * FROM teams WHERE league = 'Boys' ORDER BY wins DESC, losses, ties DESC;";
...
<div data-display="3" class="display standings">
	...
	<?php $sql = "SELECT * FROM teams WHERE league = 'Girls' ORDER BY wins DESC, losses, ties DESC;";
